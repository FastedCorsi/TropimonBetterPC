        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            try {
                ...
                if (stage == 0) {
                    ...
                    var prefs = com.google.gson.JsonParser.parseString(Files.readString(FabricLoader.getInstance().getConfigDir().resolve("tropimon_better_pc-updater.json"))).getAsJsonObject();
