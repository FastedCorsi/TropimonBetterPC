...
$smokeFlag = if ($Mode -eq 'updater') { '-Dupdater.consent.smoke=true' } else { '-Dbetterpc.smoke=true' }
if ($Mode -eq 'updater') {
...
$successMarker = if ($Mode -eq 'updater') { 'UPDATER_CONSENT_SMOKE_OK' } else { 'BETTER_PC_SMOKE_OK' }
